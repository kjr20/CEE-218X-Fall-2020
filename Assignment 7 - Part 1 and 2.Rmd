...
parcel catergories. I used 2020 data that assumes an electricity emission factor 
of 206 (PGE). I used June 2020 data to match SafeGraph data used in part 1.
...
```{r}
elec_com_use_per_sqft = seb_pge_june_2020[1,2] / seb_parcel_final_com[1,1]
```
...
```{r}
elec_com_emissions_per_sqft = seb_pge_june_2020[1,3] / seb_parcel_final_com[1,1]
```
...
```{r}
elec_res_use_per_sqft = seb_pge_june_2020[2,2] / seb_parcel_final_res[1,1]
```
...
```{r}
elec_res_emissions_per_sqft = seb_pge_june_2020[2,3] / seb_parcel_final_res[1,1]
```
...
```{r}
gas_com_use_per_sqft = seb_pge_june_2020[3,2] / seb_parcel_final_com[1,1]
```
...
```{r}
gas_com_emissions_per_sqft = seb_pge_june_2020[3,3] / seb_parcel_final_com[1,1]
```
...
```{r}
gas_res_use_per_sqft = seb_pge_june_2020[4,2] / seb_parcel_final_res[1,1]
```
